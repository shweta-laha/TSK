...
function myFunction() {
  ...
  if (x.className === "topnav") {
	...
	<section>
		<h1 style="  font-family: 'Cairo', sans-serif;  "><b>Users</b> <img src="https://img.icons8.com/external-kiranshastry-gradient-kiranshastry/48/000000/external-user-management-kiranshastry-gradient-kiranshastry-9.png"/></h1>
		<!-- TABLE CONSTRUCTION-->
    ...
    <?php // LOOP TILL END OF DATA
       while($rows=$result->fetch_assoc())
			...
			<tr>
                ...
                <td><?php echo $rows['Customer_No'];?></td>
			</tr>
